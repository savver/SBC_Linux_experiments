...
#
#  2024-11-21 03:26:04;	t_cpu=45.6;t_gpu=42.5;t_nvme_1=43.9;t_nvme_2=43.9;	1800000;1800000;1800000;1800000;
#  cpu0_user=0.0;	cpu0_nice=0.0;	cpu0_system=0.1;	cpu0_idle=99.9;	cpu0_iowait=0.0;	cpu0_irq=0.0;	
#  cpu0_softirq=0.0;	cpu0_steal=0.0;	cpu0_guest=0.0;	cpu0_guest_nice=0.0;		cpu1_user=0.1;	cpu1_nice=0.0;	
#  cpu1_system=0.5;	cpu1_idle=99.4;	cpu1_iowait=0.0;	cpu1_irq=0.0;	cpu1_softirq=0.0; ...
#
#
...
while true; do
    ...
    stats_all_tab=""
    for ((i=0; i<4; i++)); do
        str="${core_stats_raw[i]}"   
        
        str=$(echo "$str" | sed "s/;/;$tab/g")
        
        str="${str};$tab$tab"
        stats_all_tab="${stats_all_tab}${str}"
    done
    ...
    # str: datetime; + tab + temps + tab + freq_str; + tab + stats_all_tab
    line="${datetime};"$'\t'"${temps}"$'\t'"${freq_str};"$'\t'"${stats_all_tab}"
